...
{
    // 分割 invertIndex 文件
    // splitFile("/home2/ljh/LightSE/online/data/invertIndex.lib", "/home2/ljh/LightSE/online/data/words");

    // 构造字典树
    std::shared_ptr<DictTree> dictTree = mapReduce(Configuration::getpInstance() -> getConfigMap()["word_file_dir"]);

    // 测试字典树
    std::vector<string> results = dictTree -> search("中国");
